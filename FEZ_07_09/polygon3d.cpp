...
void CPolygon3D::Update(void)
{
	...
	pVtx[0].pos = D3DXVECTOR3(- m_fSizeX / 2,m_fSizeY / 2, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(+ m_fSizeX / 2,m_fSizeY / 2, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(- m_fSizeX / 2,m_fSizeY / 2, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(+ m_fSizeX / 2,m_fSizeY / 2, 0.0f);
